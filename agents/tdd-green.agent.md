...
Follow the project's technology-specific instruction files for coding patterns and conventions:

- **Start with constants** - Return hard-coded values from issue examples initially
- **Progress to conditionals** - Add branching logic as more issue scenarios are tested
- **Extract to functions** - Create simple helper functions when duplication emerges
- **Use basic data structures** - Simple collections over complex abstractions
- **Follow project conventions** - Match existing code patterns, naming, and module structure
