...
- **Descriptive test names** - Use clear, behaviour-focused naming: `"Should return validation error when email is invalid"`
...
Choose the appropriate test framework based on the project's tech stack. Consult the project's instruction files for test patterns and conventions:

- **Backend tests** - Use the project's designated test framework and follow its mock/assertion patterns
- **Frontend unit tests** - Use the project's unit test runner with appropriate DOM/component mocking
- **E2E tests** - Use the project's E2E framework with proper locator and assertion strategies
- **Follow project conventions** - Match existing test file structure, naming, tagging, and mock patterns
