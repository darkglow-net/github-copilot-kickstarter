...
tools: ['runCommands', 'runTasks', 'edit', 'search', 'extensions', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'web/fetch', 'todos']
---
...
Create individual files in `${input:FolderPath|docs/spikes}` directory. Name each file using the pattern: `[category]-[short-description]-spike.md` (e.g., `prompt-orchestration-patterns-spike.md`, `mcp-tool-discovery-spike.md`).
...
- Phase-loss mitigation strategies
- Context window management techniques

### Template Design

- Instruction scoping and `applyTo` strategies
- Agent specialization boundaries
- Skill bundling and resource management
...
- `prompt-phase-loss-mitigation-spike.md`
- `prompt-context-anchor-patterns-spike.md`
- `prompt-multi-agent-orchestration-spike.md`

**Template Design Examples:**

- `template-instruction-scoping-spike.md`
- `template-skill-resource-bundling-spike.md`
- `template-agent-specialization-spike.md`

**Architecture Examples:**

- `architecture-catalog-organization-spike.md`
- `architecture-cross-reference-validation-spike.md`
