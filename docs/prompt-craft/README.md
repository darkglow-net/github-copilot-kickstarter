...
Notes, experiments, and refined techniques for writing effective Copilot prompts, instructions, and agent definitions.
...
- [Development](../development/) — Workflows and iteration logs
- [Architecture](../architecture/) — Design decisions
- [README](../../README.md) — Back to project root
